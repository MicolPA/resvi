...
Route::middleware(['auth:sanctum', 'verified'])->get('conductores/personalizado',[ConductoresController::class,'conductoresPersonalizado'])->name('conductores.Personalizado');
//rutas para usuarios
