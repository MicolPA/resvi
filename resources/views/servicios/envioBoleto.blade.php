  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Solicitar Servicio de envio</h4>
            ...
            <form class="forms-sample">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Nombre de persona que recibe el paquete">
                </div>
                <div class="form-group">
                    <label for="exampleInputName1">Cedula</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="001-0000000-1">
                </div>
                <div class="form-group">
                    <label for="exampleInputName1">Parentezco</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Padre, Madre, Hermano, etc">
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Peso del paquete</label>
                      <div class="col-sm-9">
                        <input type="number" class="form-control" placeholder="0 LB">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
            ...
            <button onclick="comprarBoleto()" class="btn btn-primary mr-2">Agendar Envio</button>
